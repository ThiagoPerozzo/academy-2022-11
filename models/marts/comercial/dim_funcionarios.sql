...
--self join com ela mesmo por conta dos ids dos funcionarios e dos gerentes,
--nao da para fazer isso direto na staging pois é é algo que está contido na propria tabela
    , self_joined as (
        select
